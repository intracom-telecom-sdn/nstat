        ...
        for sample_id in list(range(conf['number_of_samples'] + 1)):
            ...
            if sample_id > 0:
                ...
                statistics['of_out_packets_per_sec'] = \
                    abs(res['of_out_traffic'][0] - previous_oftraf_result['of_out_traffic'][0]) / (float(oftraf_test_interval_ms) / 1000)
                statistics['of_out_bytes_per_sec'] = \
                    abs(res['of_out_traffic'][1] - previous_oftraf_result['of_out_traffic'][1]) / (float(oftraf_test_interval_ms) / 1000)
                statistics['of_in_packets_per_sec'] = \
                    abs(res['of_in_traffic'][0] - previous_oftraf_result['of_in_traffic'][0]) / (float(oftraf_test_interval_ms) / 1000)
                statistics['of_in_bytes_per_sec'] = \
                    abs(res['of_in_traffic'][1] - previous_oftraf_result['of_in_traffic'][1]) / (float(oftraf_test_interval_ms) / 1000)
                statistics['tcp_of_out_packets_per_sec'] = \
                    abs(res['tcp_of_out_traffic'][0] - previous_oftraf_result['tcp_of_out_traffic'][0]) / (float(oftraf_test_interval_ms) / 1000)
                statistics['tcp_of_out_bytes_per_sec'] = \
                    abs(res['tcp_of_out_traffic'][1] - previous_oftraf_result['tcp_of_out_traffic'][1]) / (float(oftraf_test_interval_ms) / 1000)
                statistics['tcp_of_in_packets_per_sec'] = \
                    abs(res['tcp_of_in_traffic'][0] - previous_oftraf_result['tcp_of_in_traffic'][0]) / (float(oftraf_test_interval_ms) / 1000)
                statistics['tcp_of_in_bytes_per_sec'] = \
                    abs(res['tcp_of_in_traffic'][1] - previous_oftraf_result['tcp_of_in_traffic'][1]) / (float(oftraf_test_interval_ms) / 1000)
