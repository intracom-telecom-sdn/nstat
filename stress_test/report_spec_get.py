        ...
        [report_spec.TableSpec(
            ...
            [('test_repeats', 'Test repeats'),
             ...
             ('topology_rest_server_boot',
              'Multinet boot handler'),
             ('topology_stop_switches_handler',
              'Multinet stop switches handler'),
             ('topology_get_switches_handler',
              'Multinet get switches handler'),
             ('topology_init_handler', 'Multinet initialize topology handler'),
             ('topology_start_switches_handler',
              'Multinet start topology handler'),
             ('topology_node_ip', 'Multinet IP address'),
             ('topology_rest_server_port', 'Multinet port'),
...
def sb_idle_stability_multinet(test_type, config_json, results_json):
    ...
    report_spec_obj = report_spec.ReportSpec(
        config_json, results_json,
        '{0}'.format(test_type), [report_spec.TableSpec(
            '1d', 'Test configuration parameters (detailed)',
            [('test_repeats', 'Test repeats'),
             ('controller_name', 'Controller name'),
             ('controller_build_handler', 'Controller build script'),
        ...
        [report_spec.TableSpec('2d', 'Test results',
                               [('global_sample_id', 'Sample ID'),
                                ...
                                ('add_switch_time',
                                 'Add switch time [s]'),
                                ('add_switch_rate',
                                 'Add switch rate [Flows/s]'),
                                ('add_confirm_time',
                                 'Add confirm time [s]'),
                                ('add_confirm_rate',
                                 'Add confirm rate [Flows/s]'),
                                ...
                                ('remove_controller_time',
                                 'Total time of NB Restconf calls '
                                 'for flows deletion [s]'),
                                ('remove_controller_rate',
                                 'Remove controller rate [Flows/s]'),
                                ('remove_switch_time',
                                 'Remove switch time (seconds)'),
                                ('remove_switch_rate',
                                 'Remove switch rate (Flows/seconds)'),
                                ('remove_confirm_time', 'Confirm time [s]'),
                                ('remove_confirm_rate',
                                 'Confirm rate [Flows/s]'),
                                ('end_to_end_remove_time',
                                 'Delete flows time [s]'),
                                ('end_to_end_remove_rate',
                                 'End-to-end remove rate [Flows/s]'),
                                ('nb_generator_cpu_shares',
                                 'NB traffic generator CPU percentage'),
                                ('flow_operation_delay_ms',
                                 'Flow operation delay [ms]'),
