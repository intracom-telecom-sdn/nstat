...
if __name__ == '__main__':
    filenames = ['beryllium_RPC_sb_active_stability_mtcbench_no_restart_500Switches_12Hours_results',
                 'lithium_RPC_sb_active_stability_mtcbench_no_restart_500Switches_12Hours_results']
