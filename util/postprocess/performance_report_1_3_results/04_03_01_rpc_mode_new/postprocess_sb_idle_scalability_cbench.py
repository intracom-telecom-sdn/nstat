...
def compare_controllers(filenames,number_of_runs):
    ...
    y_round_values = []
    myDiv = 1024*1024
    y_round_8000_values = [round(i) for i in boot_up_time_8000_compare[0][1]]
    y_round_16000_values = [round(i) for i in boot_up_time_16000_compare[0][1]]
    y_round_4000_values = [round(i) for i in boot_up_time_4000_compare[0][1]]
    y_round_1000_values = [round(i) for i in boot_up_time_1000_compare[0][1]]
    y_round_500_values = [round(i) for i in boot_up_time_500_compare[0][1]]
    matplotlib.rcParams.update({'font.size': 12})

    #---------------------------------------------------------------------------
    fig, ax = plt.subplots()
    plt.plot(x_data_list, boot_up_time_500_compare[0][1],'^r')
    plt.plot(x_data_list, boot_up_time_500_compare[1][1],'vb')

    for xy in zip(x_data_list, boot_up_time_500_compare[0][1]):
    ...
    plt.yticks(y_round_500_values)
    plt.title('inter thread creation delay: 0.5sec', fontsize=10)
    ...
    #---------------------------------------------------------------------------
    fig, ax = plt.subplots()
    plt.plot(x_data_list, boot_up_time_1000_compare[0][1],'^r')
    plt.plot(x_data_list, boot_up_time_1000_compare[1][1],'vb')

    for xy in zip(x_data_list, boot_up_time_1000_compare[0][1]):
        ax.annotate('{}'.format(xy[0]), xy, va='bottom',
                    textcoords='data')
    ...
    plt.grid(True)
    plt.xticks(x_data_list)
    plt.yticks(y_round_1000_values)
    plt.title('inter thread creation delay: 1sec', fontsize=10)
    plt.xlabel('number of network switches [N]', fontsize=10)
    plt.ylabel('bootup time [s]', fontsize=10)
    plt.legend(['Beryllium (RC2)','Lithium (SR3)'],
               loc='upper left', prop={'size':12})
    ...
    #---------------------------------------------------------------------------
    fig, ax = plt.subplots()
    plt.plot(x_data_list, boot_up_time_4000_compare[0][1],'^r')
    plt.plot(x_data_list, boot_up_time_4000_compare[1][1],'vb')

    for xy in zip(x_data_list, boot_up_time_4000_compare[0][1]):
        ax.annotate('{}'.format(xy[0]), xy, va='bottom',
                    textcoords='data')
    ...
    plt.grid(True)
    plt.xticks(x_data_list)
    plt.yticks(y_round_4000_values)
    plt.title('inter thread creation delay: 4sec', fontsize=10)
    plt.xlabel('number of network switches [N]', fontsize=10)
    plt.ylabel('bootup time [s]', fontsize=10)
    plt.legend(['Beryllium (RC2)','Lithium (SR3)'],
               loc='upper left', prop={'size':12})
    ...
    #---------------------------------------------------------------------------
    fig, ax = plt.subplots()
    plt.plot(x_data_list, boot_up_time_8000_compare[0][1],'^r')
    plt.plot(x_data_list, boot_up_time_8000_compare[1][1],'vb')

    for xy in zip(x_data_list, boot_up_time_8000_compare[0][1]):
        ax.annotate('{}'.format(xy[0]), xy, va='bottom',
                    textcoords='data')
    ...
    plt.grid(True)
    plt.xticks(x_data_list)
    plt.yticks(y_round_8000_values)

    plt.title('inter thread creation delay: 8sec', fontsize=10)
    plt.xlabel('number of network switches [N]', fontsize=10)
    plt.ylabel('bootup time [s]', fontsize=10)
    plt.legend(['Beryllium (RC2)','Lithium (SR3)'],
               loc='upper left', prop={'size':12})
    ...
    #---------------------------------------------------------------------------
    fig, ax = plt.subplots()
    plt.plot(x_data_list, boot_up_time_16000_compare[0][1],'^r')
    plt.plot(x_data_list, boot_up_time_16000_compare[1][1],'vb')

    for xy in zip(x_data_list, boot_up_time_16000_compare[0][1]):
        ax.annotate('{}'.format(xy[0]), xy, va='bottom',
                    textcoords='data')
    ...
    plt.grid(True)
    plt.xticks(x_data_list)
    plt.yticks(y_round_16000_values)
    plt.title('inter thread creation delay: 16sec', fontsize=10)
    plt.xlabel('number of network switches [N]', fontsize=10)
    plt.ylabel('bootup time [s]', fontsize=10)
    plt.legend(['Beryllium (RC2)','Lithium (SR3)'],
               loc='upper left', prop={'size':12})
...
"""
    for xy in zip(x_data_list, boot_up_time_8000_compare[0][1]):
        ax.annotate('{}'.format(xy[1]), xy, va='bottom',
                    textcoords='data')
    for xy in zip(x_data_list, boot_up_time_8000_compare[1][1]):
        ax.annotate('{}'.format(xy[1]), xy, va='bottom',
                    textcoords='data')
"""
