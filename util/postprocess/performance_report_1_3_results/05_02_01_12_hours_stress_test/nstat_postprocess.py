...
def json2csv(filename):
    ...
    f.writerow(["sample_id",
                "of_out_packets_per_sec",
                "of_out_bytes_per_sec"])
    for lines in lines:
        f.writerow([lines["sample_id"],
                    lines["of_out_packets_per_sec"],
                    lines["of_out_bytes_per_sec"]])
...
if __name__ == '__main__':
    filenames = ['beryllium_sb_idle_stability_multinet_results',
                 'lithium_sb_idle_stability_multinet_results']
