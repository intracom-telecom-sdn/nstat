...
exec_client_command "feature:install odl-adsal-all"
echo "feature was installed successfully"

exec_client_command "feature:install odl-adsal-northbound"
echo "feature odl-adsal-northbound was installed successfully"
