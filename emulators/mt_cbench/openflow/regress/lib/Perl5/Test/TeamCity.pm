#############################################################
# $Id: TeamCity.pm 3909 2008-06-06 03:31:57Z brandonh $
#
#
...
# Root directory for NF2 -- used to identify locations of files
my $nf2_root = '';
...
INIT {
	...
	if (defined($ENV{'NF2_ROOT'})) {
		$nf2_root = $ENV{'NF2_ROOT'};
	}
}
